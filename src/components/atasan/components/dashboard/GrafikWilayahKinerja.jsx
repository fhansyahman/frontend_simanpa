  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden mb-8">
      <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-red-50 to-green-50">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Perbandingan total kinerja (KR+KN) dengan target per wilayah
              </p>
            </div>
          </div>
        ...
        {/* PERUBAHAN: Legend hanya untuk Total Panjang dan Target */}
        <div className="flex flex-wrap gap-4 mt-3">
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded bg-green-600"></div>
            <span className="text-sm text-gray-600">Total Panjang (KR+KN)</span>
          </div>
          <div className="flex items-center gap-2">
